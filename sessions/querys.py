...
def mostrar_querys():
    ...
    st.markdown("<h1 style='color: #D4AF37;'>⛁ Querys: Preguntas del Profesor</h1>", unsafe_allow_html=True)
    st.divider()
...
"""
        ...
        if st.button("Ejecutar Validación (1 DE)", key="btn_1_val"):
            try:
                resultado_val = ejecutar_consulta_limitada(sql_input_1_val, limite=20)
